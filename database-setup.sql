-- ==========================================
-- Reading Buddy - Database Setup
-- Combined schema for CI/CD and self-hosted
-- ==========================================
...
-- (public.users is created by setup-db.ts before this file runs)
-- ============================================================================
...
-- ============================================================================
-- PART 4: CORE APPLICATION TABLES
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_student_books_epub_cfi ON student_books(student_id, book_id, epub_cfi);
